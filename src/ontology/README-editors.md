...
To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/matentzn/cato) for details.
 ...
 * https://github.com/matentzn/cato/releases
 * https://github.com/matentzn/cato/releases/new
...
Check the build status here: [![Build Status](https://travis-ci.org/matentzn/cato.svg?branch=master)](https://travis-ci.org/matentzn/cato)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/matentzn](https://travis-ci.org/profile/matentzn)
 2. click the "Sync account" button
 3. Click the tick symbol next to cato
